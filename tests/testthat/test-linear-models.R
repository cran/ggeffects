if (suppressWarnings(
  ...
  test_that("ggpredict, lm print", {
    ...
    expect_equal(
      out,
      c("# Predicted values of Total score BARTHEL INDEX", "", "#  c161sex = Male",
        "# c172code = [1] low level of education", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     73.95 | [69.35, 78.55]",
        "     45 |     62.56 | [58.23, 66.88]", "     85 |     52.42 | [47.90, 56.95]",
        "    170 |     30.89 | [24.85, 36.94]", "", "#  c161sex = Female",
        "# c172code = [1] low level of education", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     75.00 | [71.41, 78.59]",
        "     45 |     63.60 | [60.46, 66.74]", "     85 |     53.46 | [50.13, 56.80]",
        "    170 |     31.93 | [26.83, 37.04]", "", "#  c161sex = Male",
        "# c172code = [2] intermediate level of education", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     74.67 | [71.06, 78.29]",
        "     45 |     63.27 | [59.88, 66.66]", "     85 |     53.14 | [49.40, 56.89]",
        "    170 |     31.61 | [25.98, 37.24]", "", "#  c161sex = Female",
        "# c172code = [2] intermediate level of education", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     75.71 | [73.31, 78.12]",
        "     45 |     64.32 | [62.42, 66.21]", "     85 |     54.18 | [51.81, 56.55]",
        "    170 |     32.65 | [27.94, 37.36]", "", "#  c161sex = Male",
        "# c172code = [3] high level of education", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     75.39 | [71.04, 79.74]",
        "     45 |     63.99 | [59.73, 68.26]", "     85 |     53.86 | [49.23, 58.49]",
        "    170 |     32.33 | [25.95, 38.71]", "", "#  c161sex = Female",
        "# c172code = [3] high level of education", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     76.43 | [72.89, 79.98]",
        "     45 |     65.03 | [61.68, 68.39]", "     85 |     54.90 | [51.16, 58.65]",
        "    170 |     33.37 | [27.70, 39.05]", "", "Adjusted for:",
        "* neg_c_7 = 11.84")
    )
    ...
    expect_equal(
      ...
      c("# Predicted values of Total score BARTHEL INDEX", "", "# c161sex = Male",
        ...
        "# neg_c_7 = 11.8", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     75.78 | [73.38, 78.18]",
        "     45 |     64.38 | [62.49, 66.28]", "     85 |     54.25 | [51.89, 56.61]",
        "    170 |     32.72 | [28.01, 37.42]", "", "# c161sex = Male",
        ...
        "# neg_c_7 = 15.7", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     66.82 | [63.70, 69.94]",
        "     45 |     55.42 | [52.94, 57.91]", "     85 |     45.29 | [42.65, 47.93]",
        "    170 |     23.76 | [19.18, 28.34]", "", "# c161sex = Male",
        ...
        "# neg_c_7 = 8", "", "c12hour | Predicted |         95% CI",
        "------------------------------------", "      0 |     84.51 | [81.75, 87.27]",
        "     45 |     73.11 | [70.51, 75.71]", "     85 |     62.98 | [59.83, 66.13]",
        "    170 |     41.45 | [36.07, 46.83]", "", "Adjusted for:",
        "* c172code = 1.97")
    )
  })
