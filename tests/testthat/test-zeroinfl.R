...
test_that("ggpredict, pscl", {
  ...
  expect_equal(pr$conf.low, c(0.17311, 2.01717), tolerance = 1e-3)
  ...
  expect_equal(
    pr$conf.low,
    c(1e-05, 1e-05, 0.03704, 1e-05, 1e-05, 0.14815, 0.13418, 1.61886,
      0.04808, 1.81329, 0.48571, 3.07056, 3.1093, 1.33136),
    tolerance = 1e-2
  )
})
